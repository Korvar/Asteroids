...
class Registry
{
	...
	public static var worldMaxX:Float = 5000;
	public static var worldMinY:Float = 0;
	public static var worldMaxY:Float = 5000;
	...
	public static var thrustMax:Float = 300;
	
	public static var maneuverJetThrust:Float = 20;
